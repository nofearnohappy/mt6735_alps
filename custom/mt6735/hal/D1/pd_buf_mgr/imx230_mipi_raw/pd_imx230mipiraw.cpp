...
MINT32 PD_IMX230MIPIRAW::SetRegData(unsigned short &CurrMode)
{
	...
	if( CurrMode==0 || CurrMode==2)
	{
		...
		if( CurrMode==2)// bining mode	
		{
			...
			ImageSensorRegisterData.reg_addr_0x0349 = 0x70; 
			ImageSensorRegisterData.reg_addr_0x034A = 0x07; // y_add_end
			ImageSensorRegisterData.reg_addr_0x034B = 0xD8; 					
			// Output Size Setting
			// Output
		...
		else // all pixel mode
		{
			...
			ImageSensorRegisterData.reg_addr_0x0349 = 0xE0; 
			ImageSensorRegisterData.reg_addr_0x034A = 0x0F; // y_add_end
			ImageSensorRegisterData.reg_addr_0x034B = 0xB0; 		
			// Output Size Setting
			// Output
