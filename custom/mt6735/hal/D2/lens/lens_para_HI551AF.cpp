...
const NVRAM_LENS_PARA_STRUCT HI551AF_LENS_PARA_DEFAULT_VALUE =
{
    //Version
...
UINT32 HI551AF_getDefaultData(VOID *pDataBuf, UINT32 size)
{
    ...
    memcpy(pDataBuf, &HI551AF_LENS_PARA_DEFAULT_VALUE, dataSize);

    return 0;
}

PFUNC_GETLENSDEFAULT pHI551AF_getDefaultData = HI551AF_getDefaultData;
