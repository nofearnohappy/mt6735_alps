...
extern PFUNC_GETLENSDEFAULT pHI551AF_getDefaultData;
extern PFUNC_GETLENSDEFAULT pOV8858AF_getDefaultData;
...
MSDK_LENS_INIT_FUNCTION_STRUCT LensList_main[MAX_NUM_OF_SUPPORT_LENS] =
{
    {DUMMY_SENSOR_ID, DUMMY_LENS_ID, "Dummy", pDummy_getDefaultData},
		...
		{HI551_SENSOR_ID, DW9714AF_LENS_ID, "DW9714AF", pHI551AF_getDefaultData},
		{OV5670MIPI_SENSOR_ID, DW9714AF_LENS_ID, "DW9714AF", pDW9714AF_getDefaultData},
		{OV8858_SENSOR_ID, DW9714AF_LENS_ID, "DW9714AF", pOV8858AF_getDefaultData},
	#endif
    #if defined(DW9718AF)
        {OV8858QT_SENSOR_ID, DW9718AF_LENS_ID, "DW9718AF", pDW9718AF_getDefaultData},
    #endif
	#if defined(AD5820AF)
