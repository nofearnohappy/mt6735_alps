...
const NVRAM_LENS_PARA_STRUCT OV8858AF_LENS_PARA_DEFAULT_VALUE =
{
    //Version
...
UINT32 OV8858AF_getDefaultData(VOID *pDataBuf, UINT32 size)
{
    ...
    memcpy(pDataBuf, &OV8858AF_LENS_PARA_DEFAULT_VALUE, dataSize);

    return 0;
}

PFUNC_GETLENSDEFAULT pOV8858AF_getDefaultData = OV8858AF_getDefaultData;
