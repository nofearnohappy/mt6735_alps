...
init()
{
    ...
    //
    {
        ...
        MY_LOGD("wwm BCR getOpenId =%d", mpParamsMgr->getOpenId());
        /* No record/face detection/object tracking/PreviewFeature clients required for 2D barcode reader */
        if (mpParamsMgr->getOpenId() == 1)
        {
            ret = true;
            goto lbExit;
        }
