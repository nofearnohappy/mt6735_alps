...
public final class MTKPhone {
    public static final int NETWORK_PRECHECK = ConnectivityManager.NetworkCallback.PRECHECK; //1
    public static final int NETWORK_AVAILABLE = ConnectivityManager.NetworkCallback.AVAILABLE; //2
    public static final int NETWORK_LOST = ConnectivityManager.NetworkCallback.LOST; //4
    public static final int NETWORK_UNAVAILABLE = ConnectivityManager.NetworkCallback.UNAVAIL; //5
