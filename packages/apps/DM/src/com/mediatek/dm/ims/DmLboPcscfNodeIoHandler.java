...
public class DmLboPcscfNodeIoHandler implements NodeIoHandler {
    ...
    public int read(int offset, byte[] data) throws VdmException {
        ...
        try {
            ...
            ImsLboPcscf[] lboPcscfArray = imsConfig.getMasterLboPcscfValue();
            ...
            Log.e(TAG.NODE_IO_HANDLER, "[LboPcscf][read] ImsConfig may get error!!");
            e.printStackTrace();
        }
    ...
    public void write(int offset, byte[] data, int totalSize) throws VdmException {
        ...
        try {
            ...
            if (lboPcscf != null) {
                ...
                imsConfig.setProvisionedLboPcscfValue(lboPcscfArray);
            }
        } catch (ImsException e) {
            Log.e(TAG.NODE_IO_HANDLER, "[LboPcscf][write] ImsConfig may get error!!");
            e.printStackTrace();
        }
    }
}
