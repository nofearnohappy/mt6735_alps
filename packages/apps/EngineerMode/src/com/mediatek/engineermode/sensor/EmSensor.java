...
// ? ? 2013?09?23? 15:23:02				Xlog.d(TAG, "cktGetPsensorData return RET_SUCCESS");
                return RET_SUCCESS;
            } catch (NumberFormatException e) {
...
public static int cktGetPsensorOffData (int[] result) {
        ...
        if (ret.length >= 2 && String.valueOf(RET_SUCCESS).equals(ret[0])) {
            try {
                result[0] = Integer.parseInt(ret[1]);
// ? ? 2013?09?23? 15:23:06				Xlog.e(TAG, "cktGetPsensorOffData return RET_SUCCESS");
                return RET_SUCCESS;
            } catch (NumberFormatException e) {
                // Let it return RET_FAILED
...
public static int doCktPsensorCalibration(int[] result) {
        ...
        if (ret.length >= 2 && String.valueOf(RET_SUCCESS).equals(ret[0])) {
            try {
                result[0] = Integer.parseInt(ret[1]);
// ? ? 2013?09?23? 15:23:11				Xlog.e(TAG, "doCktPsensorCalibration return RET_SUCCESS");
                return RET_SUCCESS;
            } catch (NumberFormatException e) {
                // Let it return RET_FAILED
