...
#define uistr_battery 			  "Battery Information"
...
#define uistr_info_audio_loopback_waveplayback						"Ringtone" 
...
#define uistr_info_title_battery_tag_per "%"
#define uistr_info_title_battery_per   "BAT Percent"
/* ext buck */
