...
public class LteDataOnlyController implements ILteDataOnlyController {
    ...
    private boolean isSupportTddDataOnlyCheck() {
        ...
        boolean isSlot1ExternalModemSlot =
            (PhoneConstants.SIM_ID_1 == CdmaFeatureOptionUtils.getExternalModemSlot());
        boolean checkResult = false;

        if (isCT4gCard && isCdmaLteDcSupport && isSlot1ExternalModemSlot) {
           checkResult = true;
        }
        Xlog.d(TAG, "isCT4gCard : " + isCT4gCard
            + ", isCdmaLteDcSupport : " + isCdmaLteDcSupport
            + ", isSlot1ExternalModemSlot : " + isSlot1ExternalModemSlot
