...
#-----------------------------------------------------------
LOCAL_SRC_FILES += \
    BCRCamAdapter.3A.cpp \
    BCRCamAdapter.Capture.cpp \
    BCRCamAdapter.CaptureCallback.cpp \
    BCRCamAdapter.Preview.cpp \
    BCRCamAdapter.Record.cpp \
    BCRCamAdapter.cpp \
    BCRCamParameter.cpp \
...
#-----------------------------------------------------------
LOCAL_WHOLE_STATIC_LIBRARIES += libcam.camadapter.BCR.state
#
LOCAL_STATIC_LIBRARIES += 

#-----------------------------------------------------------
LOCAL_MODULE := libcam.camadapter.BCR

#-----------------------------------------------------------
ifeq "'1'" "$(strip $(MTKCAM_HAVE_BCR))"
