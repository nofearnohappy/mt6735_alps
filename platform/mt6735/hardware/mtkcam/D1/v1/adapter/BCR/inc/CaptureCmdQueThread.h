...
#ifndef _MTK_HAL_CAMADAPTER_BCR_INC_CAPTURECMDQUETHREAD_H_
#define _MTK_HAL_CAMADAPTER_BCR_INC_CAPTURECMDQUETHREAD_H_
//
...
#endif  //_MTK_HAL_CAMADAPTER_BCR_INC_CAPTURECMDQUETHREAD_H_
