 ...
 ************************************************************************************************/
#ifndef _MTK_CAMERA_INCLUDE_CAMNODE_BCR_CTRL_NODES_H_
#define _MTK_CAMERA_INCLUDE_CAMNODE_BCR_CTRL_NODES_H_
//
//
//
...
*
********************************************************************************/
class BCRCtrlNode : public ICamNode
{
    public:     /*createInstance()*/
        //
        static BCRCtrlNode*     createInstance(const char*  userName);
...
#endif  //  _MTK_CAMERA_INCLUDE_CAMNODE_BCR_CTRL_NODES_H_
